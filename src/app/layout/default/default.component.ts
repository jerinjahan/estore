...
import { AfterViewInit,Component,ComponentFactoryResolver,ElementRef,Inject,OnDestroy,OnInit,Renderer2,ViewChild,ViewContainerRef,} from '@angular/core';
		...
		router.events.pipe(takeUntil(this.unsubscribe$)).subscribe((evt) => {
			...
			if (evt instanceof NavigationError || evt instanceof NavigationCancel) {
				...
				if (evt instanceof NavigationError) {
					msgSrv.error(`Unable to load ${evt.url} routing`, { nzDuration: 1000 * 3 });
				}
				return;
			}
